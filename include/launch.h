...
void embedWatermark(std::string image_path, std::string watermark_path, std::string output_path, int scheme, bool debug = false, bool traceUnchanged = false, bool traceFailed = false);
